...
const Banner = () => {
  const bannerImages = useMemo(
    () => [
      "https://github.com/nuradnanchowdhury015/travello-template/blob/master/public/assets/tours-page/banner1.jpg?raw=true",
      "https://github.com/nuradnanchowdhury015/travello-template/blob/master/public/assets/tours-page/banner2.jpg?raw=true",
    ],
    []
  );
